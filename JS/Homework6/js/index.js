...
class Hamburger {
   ...
   */
  calculatePrice() {
    let x = Hamburger.STUFFINGS[this._stuffing].price;
    let y = Hamburger.SIZES[this._size].price;
    let top = this._toppings.reduce((acc, el) => acc + Hamburger.TOPPINGS[el].price, 0);
    // console.log(top);
    return x + y + top;
  ...
  calculateCalories() {
    let x = Hamburger.STUFFINGS[this._stuffing].calories;
    let y = Hamburger.SIZES[this._size].calories;
    let top = this._toppings.reduce((acc, el) => acc + Hamburger.TOPPINGS[el].calories, 0);
    // console.log(top);
    return x + y + top;
}
